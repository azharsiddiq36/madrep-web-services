<div class="limiter">
            ...
            <form enctype="multipart/form-data" class="form" method="post" action="<?php echo base_url('obat_edit/'.$record['obat_id'])?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "username">
                                <input class="input100" type="text" value="<?= $record['obat_nama']?>" name="obat_nama" placeholder="Nama Obat">
                                ...
                                <select class="input100" name="obat_id_kategori">
                                    <?php
                                        foreach ($kategori->result() as $row){
                                            if ($record['obat_id_kategori'] == $row->kategori_id){?>
                                                <option value="<?= $row->kategori_id?>" selected><?= $row->kategori_nama?></option>
                                                <?php
                                            }
                                            else{
                                            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "Tempat Lahir Tidak Boleh Kosong">
                                <input class="input100" type="text" value="<?= $record['obat_rincian']?>" name="obat_rincian" placeholder="Rincian Obat">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <input type="file" data-default-file="<?= base_url().$record['obat_foto']?>" name="obat_foto" class="dropify" data-height="200">
                            </div>
                        </td>
                    </tr>
