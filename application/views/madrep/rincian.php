<div class="limiter">
    ...
    <p align="center">
        <label class="label"><a><img src="<?= base_url().$record['madrep_foto']?>" style="width: 200px;margin-bottom: 20px;border-radius: 20px"></a></label>
    </p>
        <table class="wrap-input100">
            <tr>
                ...
                <td>:</td>
                <td>
                    <label class="label"><a><?= $record['madrep_nama']?></a></label>
                </td>
            </tr>
            <tr>
                ...
                <td>:</td>
                <td>
                    <label class="label"><a><?= $record['madrep_alamat']?></a></label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <label class="label"><a><?= $record['madrep_tgl_lahir']?></a></label>
                </td>
            </tr>
