<div class="limiter">
            ...
            <form enctype="multipart/form-data" class="form" method="post" action="<?php echo base_url()?>tambah_dokter">
                <table class="wrap-input100">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "Nama tidak boleh kosong">
                                <input class="input100" type="text" name="dokter_nama" placeholder="Nama">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
							<i class="fa fa-user" aria-hidden="true"></i>
						</span>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "Bidang tidak boleh kosong">
                                <input class="input100" type="text" name="dokter_bidang" placeholder="Bidang">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "Tempat Lahir Tidak Boleh Kosong">
                                <input class="input100" type="text" name="dokter_alamat" placeholder="alamat">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "Tempat Lahir Tidak Boleh Kosong">
                                <input class="input100" type="text" name="dokter_nomor" placeholder="nomor">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="radio-inline">
                                <input type="radio" name="dokter_jk" value="Pria" checked><span style="font-size: 15px">Pria</span>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="dokter_jk" value="Wanita"><span style="font-size: 15px">Wanita</span>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="wrap-input100 validate-input" data-validate = "Pangkat tidak boleh kosong">
                                <input class="input100" type="text" id="datepicker" name="dokter_tgl_lahir" placeholder="Tanggal Lahir">
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
